...
import { ClassRecord, StudentRecord, TeacherRecord, TagPrefix, } from './data';
...
export class BaseService {
  ...
  public getAllClasses() {
    return this.contract.pipe(
      concatMap((conn) => conn.send<ClassesResponse>('Chooser.GetAllClass')),
      map(rsp => {
  ...
  public getTags(category: 'TEACHER' | 'STUDENT') {
    return this.contract.pipe(
      concatMap((conn) => conn.send<TagPrefixResponse>('Chooser.GetAllTag', {
        Request: {
