...
(function () {
  ...
  Exam = (function () {
    ...
    avgScore = function (exam_data, isCurrSemester ,exam_process) {
      ...
      else if (isCurrSemester && (_system_exam_must_enddate === "true" || _system_fix_must_enddate === "true")) {
            ...
            if (exam) {
              ...
              if (_system_show_model === "domain" && course.Domain !== pre_domain) { 
                ...
                if (exam.Avg !== '未開放') {
                  ...
                  if (_system_exam_must_enddate === 'viewtime') {
                    var OpenTimeInfos = ViewTimeConfig.Exams.find(x => x.ExamID == exam.ExamID)
                    return tbody1.push("<td rel=\"tooltip\"\n  title=\"" + (OpenTimeInfos.ViewTime ? OpenTimeInfos.ViewTime.toString() + "後開放" : "尚未開放") + "\">\n  未開放</td>\n<td class=\"my-effect\">&nbsp;</td>");
