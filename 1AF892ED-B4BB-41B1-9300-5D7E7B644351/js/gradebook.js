                    ...
                    $scope.templateList.forEach(function (examRec, index) {
                        ...
                        if (!examRec.Lock) {
                            ...
                            [].concat($scope.studentList || []).forEach(function (studentRec) {
                                ...
                                //     if (!examRec.hasChange) { //第一次
                                //         logDescription += `輸入【${examRec.Name}】成績: \n`;
                                //         examRec.hasChange = true;
                                //     }
                                //     logDescription += `　${studentRec.ClassName}班  ${studentRec.SeatNo}號  ${studentRec.StudentName}  , ${studentRec['Exam' + examRec.ExamID + 'Origin'] || '  '} => ${studentRec['Exam' + examRec.ExamID]} \n`;
                                // }
                                ...
                                if (examRec.isSubScoreMode) {
                                    ...
                                    logDescription += `讀卡試卷成績${data.Extension.Extension['PScore']}`
                                }
